/*
  Sketch_16.1.1_UltrasonicRanging_01_Communication
...
float getSonar() {
  ...
  pingTime = pulseIn(echoPin, HIGH, timeOut);// Wait  HC_SR04 returning to the high level and measure out this waitting time
